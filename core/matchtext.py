...
class KeywordProcessor(object):
    ...
    def __init__(self, case_sensitive=False):
        ...
        try:
            # python 2.x
            self.non_word_boundaries =set('_')#change for chinese set(string.digits + string.letters + '_')
        except AttributeError:
            # python 3.x
            self.non_word_boundaries = set('_')#set(string.digits + string.ascii_letters + '_')
